...
The perceptron update rule is intuitive, but it has a limitation: it does not give a smooth notion of "how wrong" a prediction is. That is why loss functions matter.
